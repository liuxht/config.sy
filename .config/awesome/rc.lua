...
beautiful.init("/home/syc/.config/awesome/zenburn/theme.lua")
...
tags = {}
tags.settings = {
        { name = "term",  layout = layouts[0]  },
        { name = "www",   layout = layouts[0]  },
        { name = "im",    layout = layouts[0]  },
        { name = "doc",   layout = layouts[0]  },
        { name = "media",   layout = layouts[0]  }
}
...
globalkeys = awful.util.table.join(
	...
	-- Application
	awful.key({ modkey,	}, "z",	function () awful.util.spawn("xlock -mode \
	puzzle -fg green -echokeys -echokey *") end),
...
--	    local f  = io.popen("sdcv -n --utf8-output -u '牛津英汉双解美化版' "..newword)
		local f  = io.popen("sdcv -n --utf8-output -u 'Collins Cobuild English Dictionary' "..newword)
	    for line in f:lines() do
	        fc = fc .. line .. '\n'
	    end
	    f:close()
	    frame = naughty.notify({ text = fc, timeout = 240, width = 380 })
	end),
	awful.key({ modkey, "Shift" }, "d", function ()
	    ...
	    function(cinword)
	        ...
	        local fc = ""
	        local f  = io.popen("sdcv -n --utf8-output -u 'Collins Cobuild English Dictionary' "..cinword)
	        for line in f:lines() do
	            fc = fc .. line .. '\n'
	        end
	        f:close()
	        frame = naughty.notify({ text = fc, timeout = 10, width = 380 })
